  ...
  root.innerHTML = `
    <div class="topbar">
      <div class="identity">
        ...
        <div class="title">FUSELAGE MASSING · OPEN PROPULSION BAY · MOUNTED MECHANISM</div>
    ...
    <section class="control-deck">
      ...
      <div class="h1-sequence"><b>BODY REVIEW</b> BODY SPREAD → BODY MID → BODY DRIVE → TOP / SIDE / FRONT / REAR → BODY SECTION → BODY OFF → PROP + PROP SECTION</div>
    </section>
